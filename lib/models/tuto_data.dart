...
List<TutoInfo> tutos = [
  TutoInfo(
    ...
    desc:
        "Welcome to Wildrun! Embark on an eco-adventure as the mighty Eco-Hero, where you'll leap over obstacles, collect fruits, and recycle waste to restore nature's balance. Are you ready to save the environment and become a champion in this thrilling journey?",
    urlImage: 'images/tutos/play.png',
  ),
  TutoInfo(
    name: "The player - Attack",
    desc:
        "Tap the left side to launch orbs and attack polluting enemies. It takes 2 orbs to kill an enemy.",
    urlImage: 'images/tutos/attack.png',
  ),
  TutoInfo(
    name: "The player - Jump",
    desc:
        "Tap the right side of the screen or use the up arrow to make the Eco-Hero leap over obstacles.",
    urlImage: 'images/tutos/jump.png',
  ),
  TutoInfo(
  ...
  TutoInfo(
    ...
    urlImage: 'images/tutos/waste.png',
  ),
  TutoInfo(
